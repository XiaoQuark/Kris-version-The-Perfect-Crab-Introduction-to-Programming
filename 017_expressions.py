...
# evaluates to 7. add_one is invoked 6 times, and every time we are adding 1 to the previous result. As we started from 1, it's like doing 1 + 6.
...
add_one(add_one(6) + add_one(3) * add_one(2) - add_one(4))

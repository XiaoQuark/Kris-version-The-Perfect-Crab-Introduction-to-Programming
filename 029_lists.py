...
my_favourite_dinosaurs = ["Velociraptor", "Yutyrannus", "Ankylosaurus", "Microraptor", "Microceratus", "Archaeopteryx", "Magpie", "Cassowary", "Roadrunner", "Seriema", "Crow", "Great Eared Nightjar"]
print(my_favourite_dinosaurs)
